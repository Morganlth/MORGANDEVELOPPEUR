// #EXPORTS
    ...
    export const SKILLS_TAGS_DATAS = ['HTML - CSS', 'JAVASCRIPT', 'NODE JS', 'GESTION - OUTILS', 'ADAPTABILITE']

    export const SKILLS_SKILLS_DATAS = 
    [
        [
    ...
    ].map((skills, i) => ({ tag: SKILLS_TAGS_DATAS[i], skills: skills }))